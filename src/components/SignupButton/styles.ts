export const signupButtonStyles = {
  button: "group px-6 py-3 h-12 bg-white text-black rounded-lg hover:bg-gray-200 flex items-center font-semibold text-[16px] overflow-hidden transition-colors",
